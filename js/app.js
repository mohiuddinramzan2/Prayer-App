...
const AzanPlayer = {
  // প্রতিবার নতুন Audio object তৈরি করা হয়
  // এতে browser "user gesture" হিসেবে গণ্য করে এবং block করে না
  play(prayer) {
...
// আজান পরীক্ষা বাটন — সরাসরি play, কোনো delay নেই
function testAzan() {
...
function getLocation() {
  if (!navigator.geolocation) {
    useFallback("Geolocation সাপোর্ট নেই");
    return;
  }
...
// ── Azan Check (প্রতি মিনিটে) ────────────────────────
// নোট: নামাজের ওয়াক্তে স্বয়ংক্রিয় আজান শুধু তখনই
// বাজবে যদি ব্যবহারকারী আগে পেজে ইন্টারেক্ট করেছেন।
// এটা সব browser-এর নিয়ম, আমরা এড়াতে পারব না।
